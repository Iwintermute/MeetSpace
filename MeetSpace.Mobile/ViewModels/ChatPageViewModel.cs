...
public sealed class ChatPageViewModel : ObservableObject
{
	...
	private bool _isCallControlsVisible;
	private bool _isMediaHostVisible;
	private double _mediaHostHeight;
	...
	{
		get => _isMessagesVisible;
		private set => SetProperty(ref _isMessagesVisible, value);
	}

	public bool IsComposerVisible
	{
		get => _isComposerVisible;
		private set => SetProperty(ref _isComposerVisible, value);
	}
	...
	public bool IsIncomingCallVisible
	{
		...
		private set => SetProperty(ref _isIncomingCallVisible, value);
	}
	...
	public bool IsCallControlsVisible
	{
		get => _isCallControlsVisible;
		private set => SetProperty(ref _isCallControlsVisible, value);
	}

	public bool IsMediaHostVisible
	{
		get => _isMediaHostVisible;
		private set => SetProperty(ref _isMediaHostVisible, value);
	}

	public double MediaHostHeight
	{
		get => _mediaHostHeight;
		private set => SetProperty(ref _mediaHostHeight, value);
	}
	...
	public async Task ActivateAsync(IDispatcher dispatcher)
	{
		if (_isActive)
			return;
	...
	private void ApplyCallState(CallSessionState state)
	{
		...
		IsCallControlsVisible = canShowMedia;
		IsMediaHostVisible = canShowMedia;
		MediaHostHeight = canShowMedia ? 320 : 0;
