...
public sealed class ConferenceRoomPageViewModel : ObservableObject
{
	...
	public bool IsChatPanelVisible
	{
		...
		private set => SetProperty(ref _isChatPanelVisible, value);
	}
	...
	public async Task ActivateAsync(string conferenceId, IDispatcher dispatcher, CancellationToken cancellationToken)
	{
		if (_isActive)
			return;
